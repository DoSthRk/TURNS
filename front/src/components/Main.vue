        ...
        <el-menu :default-active="activeMenu" @select="handleMenuSelect" class="sidebar-menu">
          ...
          <el-submenu v-if="isAdmin" index="admin">
            <template slot="title">
              ...
              <span class="menu-item">管理配置</span>
            </template>
            <el-menu-item index="admin-module-config">
              <i class="el-icon-set-up"></i>
              <span>模块与分类配置</span>
            </el-menu-item>
            <el-menu-item index="admin-shift-settings">
    ...
    handleMenuSelect(index) {
      ...
      switch(index) {
        ...
        case 'admin-module-config':
          this.currentComponent = 'ModuleConfig';
          break;
        case 'admin-shift-settings':
          this.currentComponent = 'ShiftSettings';
          break;
      }
    },
    // 修改密码
